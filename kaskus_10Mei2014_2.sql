...
--
-- Host: localhost
-- Generation Time: May 10, 2014 at 03:18 PM
...
CREATE TABLE `question` (
  ...
  `question_status` enum('0','1') NOT NULL,
  `question_added` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `show_to_web` enum('0','1') NOT NULL DEFAULT '0',
...
INSERT INTO `question` (`question_id`, `question_surveyid`, `order_number`, `question_type`, `question_title`, `question_option`, `with_notes`, `question_mandatory`, `question_status`, `question_added`, `show_to_web`, `is_delete`) VALUES
(1, 1, 1, '', 'Question Check', 'Check1\nCheck2\nCheck3', '0', '1', '1', '2013-12-03 09:13:48', '0', '0'),
(2, 1, 1, 'radio', 'Question Radio', 'Radio1\nRadio2\nRadio3', '0', '1', '1', '2013-12-03 09:14:04', '0', '0'),
(3, 1, 1, 'textarea', 'Question Textarea', '', '0', '1', '1', '2013-12-03 09:14:17', '0', '0'),
(4, 2, 1, '', 'Question Check', 'Check1\nCheck2\nCheck3', '0', '0', '1', '2013-12-03 11:13:25', '0', '0'),
(5, 2, 1, 'radio', 'Question Check', 'Check1\nCheck2\nCheck3', '0', '0', '1', '2013-12-03 11:13:36', '0', '0'),
(6, 2, 1, 'textarea', 'Question Textarea', '', '0', '0', '1', '2013-12-03 11:13:44', '0', '0'),
(7, 3, 1, '', 'Coba checkbox', 'Checkbox 1\nCheckbox 2\nCheckbox 3', '0', '1', '1', '2013-12-04 07:09:24', '0', '0'),
(8, 4, 1, '', 'Does the agency team understand the business objectives and the task at hand? ', 'Consistently does not meet standard\nMixed – sometimes meets standards \nConsistently meets standards \nSometimes above standards and sometimes exceptional work \nAlways exceptional work ', '0', '1', '1', '2013-12-11 04:46:57', '0', '0'),
(9, 4, 1, '', 'Are the agency team problem solvers, and able to think on their feet rather than take orders? ', 'Consistently does not meet standard\nMixed – sometimes meets standards \nConsistently meets standards \nSometimes above standards and sometimes exceptional work \nAlways exceptional work \n', '0', '1', '1', '2013-12-11 04:47:17', '0', '0'),
(10, 4, 1, '', 'Does the agency team deliver quality work and deliver it on time? ', 'Consistently does not meet standard\nMixed – sometimes meets standards \nConsistently meets standards \nSometimes above standards and sometimes exceptional work \nAlways exceptional work ', '0', '1', '1', '2013-12-11 04:50:14', '0', '0'),
(11, 5, 1, '', 'Is he a jerk', 'yew\nyes\nmaybe\nno', '0', '1', '1', '2014-02-18 06:28:35', '0', '0'),
(12, 6, 1, '', 'How great is our service', 'Great\nExcellent\nOut of this world\nnone of the above', '0', '0', '1', '2014-02-18 07:58:09', '0', '0'),
(13, 8, 1, '', 'Is Krisna doing his job', 'yes\nNo\nMaybe\nHe sleeps all day', '0', '1', '1', '2014-02-18 09:17:35', '0', '0'),
(14, 8, 1, '', 'are you OK?', 'yes\nno\nmaybe', '0', '1', '1', '2014-02-18 09:33:47', '0', '0'),
(15, 9, 1, 'radio', 'Yes or NO ?', 'Yes\r\nNo', '0', '1', '1', '2014-02-26 03:37:07', '0', '0'),
(16, 9, 1, 'textarea', 'Alamat anda ?', '', '0', '1', '1', '2014-02-26 03:37:34', '0', '0'),
(17, 9, 1, '', 'Makanan Favorit', 'Ayam\r\nBebek\r\nIkan', '0', '1', '1', '2014-02-26 03:38:10', '0', '0'),
(18, 10, 1, 'textarea', 'Test', 'test', '0', '1', '1', '2014-05-06 05:57:57', '0', '0'),
(19, 10, 1, 'checkbox', 'Apakah Kamu', 'hehe\r\nhuhu\r\nhooho', '1', '1', '1', '2014-05-06 06:01:26', '1', '0'),
(20, 11, 1, 'textarea', 'is this good', 'yes\nno\nsort of', '1', '1', '1', '2014-05-09 06:13:32', '0', '1'),
(21, 11, 1, 'checkbox', 'are you OK', 'fine\nsick\nwell', '0', '1', '1', '2014-05-09 06:14:44', '0', '1'),
(22, 11, 1, 'checkbox', 'How ''s the weather today?', 'Sunny\nCloudy\nGloomy', '0', '1', '1', '2014-05-10 06:36:36', '0', '0'),
(23, 10, 1, 'checkbox', 'How are you?', 'fine\nnot well\ngloomy\nexcited', '0', '1', '1', '2014-05-10 11:26:01', '0', '0');
...
(12, '1', 5, 'Dummy 1', '1', '2014-05-09 12:59:59'),
(13, '1', 5, 'Dummy 2b', '1', '2014-05-09 13:01:37'),
(14, '1', 5, 'Dummy 3c', '0', '2014-05-09 13:59:55'),
(15, '1', 5, 'Dummy 4', '0', '2014-05-09 14:32:27'),
