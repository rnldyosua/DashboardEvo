...
class Question extends CI_Controller {
	...
	public function survey($id){
                ...
                #query questions
                $fields = "'question_id,question_type,question_title,question_option,question_mandatory','question',"question_status='1' AND question_surveyid='$survey_id'";
                $getData = $this->query_model->getData(,$limit,$offset,'question_id');
